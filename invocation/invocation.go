...
type Context struct {
	Arguments *json.RawMessage `json:"arguments"` // AWS Documentation: A map containing all GraphQL arguments for this field
	Source    *json.RawMessage `json:"source"`    // AWS Documentation: A map containing the resolution of the parent field.
